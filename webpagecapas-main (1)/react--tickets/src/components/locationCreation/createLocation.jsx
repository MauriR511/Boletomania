...
const createLocation = () => {
    ...
    async function onSubmit(e) {
        ...
        try {
            const response = await axios.post('http://localhost:8080/site/save', {
        ...
        <>
            ...
            <form className="" onSubmit={onSubmit}>
                ...
                <div className="flex justify-center">
                    ...
                    <Link
                        to="/peopleView"
                        className="text-black mx-5 bg-nav-color hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-1/3 px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                        Atras
                    </Link>
